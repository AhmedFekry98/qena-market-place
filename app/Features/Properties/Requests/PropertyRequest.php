...
class PropertyRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        ...
        if($this->method() === 'PUT') {
            return [
                ...
                'images.*' => 'required_if:images.*,image|mimes:jpeg,png,jpg,gif,svg|max:2048',
    ...
    public function messages(): array
    {
        return [
            ...
            'listing_type.required' => 'نوع الإعلان مطلوب',
            'listing_type.in' => 'نوع الإعلان يجب أن يكون: إيجار أو بيع',
