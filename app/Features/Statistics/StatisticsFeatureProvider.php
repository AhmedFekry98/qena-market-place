...
namespace App\Features\Statistics;
...
class StatisticsFeatureProvider extends ServiceProvider
{
    public $featureName = "Statistics";

    public $featureNameLower = "statistics";
