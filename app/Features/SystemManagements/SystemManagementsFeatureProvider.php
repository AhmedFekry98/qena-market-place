...
namespace App\Features\SystemManagements;
...
class SystemManagementsFeatureProvider extends ServiceProvider
{
    public $featureName = "SystemManagements";

    public $featureNameLower = "systemmanagements";
